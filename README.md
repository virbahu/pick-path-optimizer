...
```bash
git clone https://github.com/virbahu/pick-path-optimizer.git
cd pick-path-optimizer
pip install -r requirements.txt
python pick_path_optimizer.py
```
...
```python
# Quick start example
from pick_path_optimizer import *
...
# See docstrings in pick_path_optimizer.py for full parameter reference
```
